...
const CreateRecipe = (props) => {
    /* 
     * Need a way to get addOrEdit, currentId, and profileObjects 
     * from ProfileBase to EditMenuProfileBase through props. Just
     * not sure if there's an elegant way to do that or if I need to
...
class EditProfileMenuBase extends Component {
    constructor(props) {
        super(props);
